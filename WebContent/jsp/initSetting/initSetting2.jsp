...
<!-- panel 0 - 처음 인사말 -->
  <div class="containorWrapper greetingContainor" ng-if="panel==0" >
		<h1 class="center-headFont primaryFont introFont">ICE EM에 오신 것을 환영합니다!</h1>
		<div class="brandIntroWrap">
			<h4>우암과 함께하는 친환경 에너지 저장 솔루션</h4>
			<h1 class="" style="font-size: 5.5em;font-weight: 600;color: #fff;text-shadow: 0px 0px 15px #00294f;">SMART ICE EM</h1>
			<h3>우암코퍼레이션의 충전 에너지 솔루션 SMART ICE EM</h3>
		...
		<div id="introBg" style="width: 100%;height: 800px;overflow: hidden;position: absolute;top: 10%;z-index: -1;overflow-y: hidden;">
...
<div class="containorWrapper" ng-if="panel==4" >
	<div class="containor lgConbox">
		...
		<!--    		<button type="button" class="btn btn-default nextBtn btn-lg" ng-click="nextPanel()" ng-disabled="deviceValidate()" ng-if="!((devpanel==4) &&(panel==4))">다음</button> -->
	   		...
	   		<button type="button" class="btn btn-red nextBtn btn-lg" ng-click="nextPanel()" ng-if="(devpanel==4) &&(panel==4)">완료</button>
		</div>
	</div>
</div>
